...
job_submit_0=$(sbatch job_surv_probs.slurm -1.0 1.0 1.0 -1.0 $rwc $rmc);
...
job_submit_1=$(sbatch --dependency=aftercorr:$job_array_id0 job_surv_probs.slurm 0.5 -0.5 -0.25 0.25 $rwc $rmc);
...
job_submit_2=$(sbatch --dependency=aftercorr:$job_array_id1 job_surv_probs.slurm 0.5 -0.5 0.75 -0.75 $rwc $rmc);
...
job_submit_3=$(sbatch --dependency=aftercorr:$job_array_id2 job_surv_probs.slurm -0.25 0.25 0.75 -0.75 $rwc $rmc);
