...
cp job_surf_probs_default.slurm job_surf_probs.slurm
...
sed -i "s/T_3000000/T_$3/g" job_surf_probs.slurm;
sed -i "s/NUMITERS/$4/g" job_surf_probs.slurm;
